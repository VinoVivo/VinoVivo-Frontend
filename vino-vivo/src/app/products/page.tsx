...
const ProductsPage = () => {
    ...
    }, [products, searchTerm, selectedTypes, selectedVarieties, selectedWineries, minPrice, maxPrice]);
            ...
            <div className="w-full sm:w-72 p-3 mt-4 sm:mt-0">
                ...
                <div className='mt-4'>
                    ...
                    <Accordion title="Tipo">
                        <ul>
                            {Array.from(new Set(products.map(product => product.nameType))).map(type => (
                    ...
                    <Accordion title="Variedad">
                        <ul>
                            {Array.from(new Set(products.map(product => product.nameVariety))).map(variety => (
                ...
                <div className="flex justify-center">
                    {filteredProducts.length === 0 && !loading ? (
                        <div className="flex items-start justify-center min-h-screen">
                            <p className="text-violeta text-xl font-semibold">No se encontraron productos</p>
                        </div>
                    ) : (
