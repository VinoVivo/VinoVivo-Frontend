    ...
    return (
        <>
            <CardContent className="flex flex-col mt-6 items-center sm:items-start">
                <div className="flex justify-center mb-4 border-b-2 border-t-2 border-[#5B483A] w-[90%] sm:w-[95%] mt-4">
                    <h1 className="text-2xl font-normal border-b-2 text-center p-2">Especificaciones</h1>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-1 gap-y-2 gap-x-8 mb-4 mt-3">
                    <div className="">
