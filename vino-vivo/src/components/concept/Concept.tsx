  ...
  return (
    <div className='flex-col space-between  w-full px-5 sm:px-2'>
      <section className=' md:px-16  w-11/12 mt-60 sm:px-1 mx-auto '>
        ...
        <p className='text-secondary text-sm sm:py-10 sm:text-md md:py-0 '>Renato Pagliano, creador de VinoVivo, tiene 38 años.  Casado y con un hijo, vivió en Almagro toda su vida, dedicándose al rubro desde pequeño por por herencia familiar. 
