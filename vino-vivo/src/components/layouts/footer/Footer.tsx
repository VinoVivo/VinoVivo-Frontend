            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-6 py-7 ">
                    ...
                    <div className="m-2 sm:col-span-2 items-center flex flex-col justify-center">
                        ...
                        <div className="flex flex-col mx-auto mt-1 space-y-3 md:space-y-0 md:flex-row">
                            <input id="email"
                                type="text"
                        ...
                        <div className="flex items-center justify-between mt-3">
                            <div className="flex -mx-2">
                                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300" aria-label="Reddit">
                                ...
                                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300" aria-label="Facebook">
                                    <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <a href="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300" aria-label="Github">
                                    <svg className="w-7 h-7 fill-current" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
